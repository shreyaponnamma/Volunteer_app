                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      <th>
                                    ...
                                    $sql1 = "select v.* from volunteer_details v,booking_details b where v.v_id = b.v_id and v.v_id =12;";
                                    ...
                                    while ($result = mysqli_fetch_assoc($row1)) {
                                        ...
                                        echo "<tr>
                                        <td>" . $result['v_name'] . "</td>
                                        <td>" . $result['v_phone'] . "</td>
                                        <td>" . $result['email'] . "</td>
                                        <td>" . $result['rating'] . "</td>
                                        <td class=\"text-right\">
                                             <button id='".$id1."' onClick ='start(this.id)' type=\"button\" rel=\"tooltip\" class=\"btn btn-info btn-sm \">
                                                <i class=\"now-ui-icons\">Start</i>
                                             </button>
                                            </td>
...
<script type ="text/javascript">
    ...
    function start(clicked_id) {
        ...
        window.location.href = ("start_cust.php?email="+clicked_id);
