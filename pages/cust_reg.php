            ...
            <div class="card card-signup text-center">
              ...
              <div class="card-body">
                <form class="form" method="" action="">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" placeholder="Gaudian Name ">
                  </div>
                  <div class="input-group">
                    <input type="text" class="form-control" placeholder="Gaudian Mob.Number">
                  </div>
                  <div class="input-group">
                    <input type="text" class="form-control" placeholder="Mediacl History ">
                  </div>
                    <div class="card-footer ">
                        <a href="#pablo" class="btn btn-primary btn-round btn-lg">Register</a>
                    </div>
                </form>
              </div>
            </div>
