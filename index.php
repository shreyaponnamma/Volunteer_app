          ...
          <div class="row">
            ...
            <div class="col-md-12 mr-auto">
              <div class="card card-signup text-center">
                ...
                <div class="card-body ">
                  <form class="form" method="post" action="func/log.php">
                    ...
                    <a href="pages/cust_reg.php">Create an account</a><br>
                    <a href="pages/vol_reg.php">I want to be volunteer</a>

                      <div class="card-footer ">
                          <button type="submit" " class="btn btn-primary btn-round btn-lg">Login</button>
                      </div>
                  </form>
                </div>
